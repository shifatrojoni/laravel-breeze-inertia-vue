...
<div class="site-section bg-light">
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="card">
        <div class="card-header">
          <h3 class="text-dark">New Product 1</h3>
        </div>
        <div class="card-body">
          <img src="images/product_01.png" alt="" width="100px">
        </div>
        <div class="card-foorte">
          <p class="price float-right">$120.00</p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card">
        <div class="card-header">
          <h3 class="text-dark">New Product 2</h3>
        </div>
        <div class="card-body">
          <img src="images/product_02.png" alt="" width="100px">
        </div>
        <div class="card-foorte">
          <p class="price float-right">$120.00</p>
        </div>
    ...
    <div class="col-md-3">
      <div class="card p-0">
        <div class="card-header">
          <h3 class="text-dark">New Product 3</h3>
        </div>
        <div class="card-body">
          <img src="images/product_03.png" alt="" width="100px">
        </div>
        <div class="card-foorte">
          <p class="price float-right">$120.00</p>
        </div>
    ...
    <div class="col-md-3">
      <div class="card">
        <div class="card-header">
          <h3 class="text-dark">New Product 4</h3>
        </div>
        <div class="card-body">
          <img src="images/product_04.png" alt="" width="100px">
        </div>
        <div class="card-foorte">
          <p class="price float-right">$120.00</p>
        </div>
